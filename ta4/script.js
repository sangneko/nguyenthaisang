document.addEventListener('DOMContentLoaded', function() {
    ...
    const questionsData = [
        ...
        { question: "My boss ______ constantly ______ me in my last job. I hated it.", options: ["was / phoned", "was / called", "is / phoning", "was / phoning"], answer: "was / phoning" }, [cite: 39]
        { question: "My job is ______ boring every now and then. I'd like to do something ______ interesting.", options: ["much/many", "a bit/more", "little/much", "somewhat/more"], answer: "a bit/more" }, [cite: 40]
        { question: "Japan imports ______ oil from other countries. Its exports include cars and electronics.", options: ["a lot of", "a large number of", "several of", "a number of"], answer: "a lot of" }, [cite: 41]
        ...
        { question: "I ______ Noriko in town 2 days ago. She ______ a pink dress and an orange hat!", options: ["saw / was wearing", "see / wears", "saw / wore", "see / is wearing"], answer: "saw / was wearing" }, [cite: 90, 97]
        { question: "Last night Section TV came out with a shock on air. The TV star, who ______ with Dan Walker, was suddenly replaced by Sally Nugent for the last half of the show.10", options: ["presents", "were presented", "have presented", "was presenting"], answer: "was presenting" }, [cite: 98]
        ...
        { question: "I know you want to move everything quickly, but this box ______ heavier and heavier.", options: ["gets", "will get", "C. might get", "D. is getting"], answer: "is getting" }, [cite: 104]
        ...
        { question: "Do you know our city? No, this is the first time I ______ here.", options: ["was", "came", "am coming", "D. have been"], answer: "D. have been" }, [cite: 106]
